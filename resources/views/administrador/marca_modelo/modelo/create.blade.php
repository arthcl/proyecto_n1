	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-lg-12 text-center col-sm-6">
				<h1 class="m-0 text-dark ">Ingresar Modelo</h1>
				<hr>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
...
<div class="container">
	<div class="row">
	  	<div class="col-12 col-lg-10 mx-auto mb-5">
			...
			<form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('modelo.store') }}"> 
				@csrf
				<input type="hidden" name="vigencia" value="1">

                <div class="col-md-6 mb-2">
                    <label for="marca" class="form-label">Marca</label>
                    <select class="form-control" id="select_marca" name="marca_vehiculo_id" autocomplete="select_marca" required>
                    ...
                    <div class="invalid-feedback">
                      Favor seleccionar marca.
                    </div>
                  </div>
                
				<div class="col-md-6 mb-2">
					<label for="descripcion" class="form-label">modelo de vehiculo</label>
